    ...
    return (
        <>
            ...
            <main className="flex justify-center px-4 pb-10 pt-6 sm:min-h-[calc(100svh-132px)] sm:py-10">
                <section className="flex w-[min(92vw,720px)] flex-col items-left gap-4 text-center text-white sm:gap-4 lg:gap-4">
                    <h1 className="z-10 max-w-[11ch] font-mackinac text-[clamp(3.2rem,12vw,3.2rem)] font-normal leading-[1] text-[#ffffff]/90 tracking-[-.04em] sm:max-w-none mb-6">
                        Privacy Policy
                    </h1>
                    <h2 className="z-10 mt-4 font-mackinac text-left text-base font-normal leading-[1.4] tracking-[-.01em] text-[#ffffff]/80 sm:text-[1.5rem] text-[1.25rem]">
                        1 · Who We Are
                    </h2>
                    ...
                    <ul className="z-10 list-disc pl-6 font-antique-legacy text-left font-normal leading-[1.4] tracking-[-.01em] text-white/65 sm:text-[1.1rem]">
